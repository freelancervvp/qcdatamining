...
testset.predict.rf.1 <- select(testset, download_speed, upload_speed, new_month,
...
str(testset.predict.rf.1)
str(select(temp.lte.d.train, download_speed, upload_speed, new_month,
           new_year,new_weekday, new_network_country, network_id, 
           rssi, ec_io, rsrp, rsrq, rssnr, 
           network_id_sim, test_type, icmp_ping_time, icmp_ping_packet_loss,
           icmp_ping_range, app_version_code))
...
#lte.d
testset.predict.rf.1$new_month <- as.factor(testset.predict.rf.1$new_month)
levels(testset.predict.rf.1$new_month) <- levels(temp.lte.d.train$new_month)
testset.predict.rf.1$new_year <- as.factor(testset.predict.rf.1$new_year)
testset.predict.rf.1$new_weekday <- as.factor(testset.predict.rf.1$new_weekday)
testset.predict.rf.1 <- na.roughfix(testset.predict.rf.1)
testset.predict.rf.1$download_speed <- as.integer(testset.predict.rf.1$download_speed)
testset.predict.rf.1$upload_speed <- as.integer(testset.predict.rf.1$upload_speed)
testset.predict.rf.1$new_network_country <- as.integer(testset.predict.rf.1$new_network_country)
testset.predict.rf.1$network_id <- as.integer(testset.predict.rf.1$network_id)
testset.predict.rf.1$rsrp <- as.integer(testset.predict.rf.1$rsrp)
testset.predict.rf.1$lte.d <- predict(rf.lte.d, testset.predict.rf.1)
summary(testset.predict.rf.1$lte.d)

#lte.u
levels(testset.predict.rf.1$new_month)
levels(temp.lte.u.train$new_month)
table(testset.predict.rf.1$new_month)
table(temp.lte.u.train$new_month)
testset.predict.rf.1[which(testset.predict.rf.1$new_month == 11),]$new_month <- 12 #shame on me
testset.predict.rf.1$new_month <- factor(testset.predict.rf.1$new_month)
testset.predict.rf.1$lte.u <- predict(rf.lte.u, testset.predict.rf.1)
summary(testset.predict.rf.1$lte.u)

#umts.d
str(testset.predict.rf.1)
str(select(temp.umts.d.train, download_speed, upload_speed, new_month,
           new_year,new_weekday, new_network_country, network_id, 
           rssi, ec_io, rsrp, rsrq, rssnr, 
           network_id_sim, test_type, icmp_ping_time, icmp_ping_packet_loss,
           icmp_ping_range, app_version_code))
levels(testset.predict.rf.1$new_month) <- levels(temp.umts.d.train$new_month)
testset.predict.rf.1$umts.d <- predict(rf.umts.d, testset.predict.rf.1)
summary(testset.predict.rf.1$umts.d)

#umts.u
testset.predict.rf.1$umts.u <- predict(rf.umts.u, testset.predict.rf.1)
summary(testset.predict.rf.1$umts.u)

#cdma.d
str(testset.predict.rf.1)
str(select(temp.cdma.d.train, download_speed, upload_speed, new_month,
           new_year,new_weekday, new_network_country, network_id, 
           rssi, ec_io, rsrp, rsrq, rssnr, 
           network_id_sim, test_type, icmp_ping_time, icmp_ping_packet_loss,
           icmp_ping_range, app_version_code))
levels(testset.predict.rf.1$new_month)
levels(temp.cdma.d.train$new_month)
table(testset.predict.rf.1$new_month)
table(temp.cdma.d.train$new_month)
testset.predict.rf.1[which(testset.predict.rf.1$new_month == 11),]$new_month <- 12 #shame on me
testset.predict.rf.1$new_month <- factor(testset.predict.rf.1$new_month)
testset.predict.rf.1$new_network_country <- as.factor(testset.predict.rf.1$new_network_country)
str(testset.predict.rf.1)
testset.predict.rf.1$new_network_country <- factor(testset.predict.rf.1$new_network_country, levels = levels(temp.cdma.d.train$new_network_country))
str(testset.predict.rf.1$new_network_country)
levels(testset.predict.rf.1$new_network_country)
testset.predict.rf.1$cdma.d <- predict(rf.cdma.d, testset.predict.rf.1)
summary(testset.predict.rf.1$cdma.d)

#cdma.u
str(testset.predict.rf.1)
str(select(temp.cdma.u.train, download_speed, upload_speed, new_month,
           new_year,new_weekday, new_network_country, network_id, 
           rssi, ec_io, rsrp, rsrq, rssnr, 
           network_id_sim, test_type, icmp_ping_time, icmp_ping_packet_loss,
           icmp_ping_range, app_version_code))
testset.predict.rf.1$new_network_country <- factor(testset.predict.rf.1$new_network_country, levels = levels(temp.cdma.u.train$new_network_country))
testset.predict.rf.1$cdma.u <- predict(rf.cdma.u, testset.predict.rf.1)
summary(testset.predict.rf.1$cdma.u)

#gsm.d
str(testset.predict.rf.1)
str(select(temp.gsm.d.train, download_speed, upload_speed, new_month,
           new_year,new_weekday, new_network_country, network_id, 
           rssi, ec_io, rsrp, rsrq, rssnr, 
           network_id_sim, test_type, icmp_ping_time, icmp_ping_packet_loss,
           icmp_ping_range, app_version_code))
testset.predict.rf.1$new_network_country <- testset$new_network_country
testset.predict.rf.1$gsm.d <- predict(rf.gsm.d, testset.predict.rf.1)
summary(testset.predict.rf.1$gsm.d)

#gsm.u
str(testset.predict.rf.1)
str(select(temp.gsm.u.train, download_speed, upload_speed, new_month,
           new_year,new_weekday, new_network_country, network_id, 
           rssi, ec_io, rsrp, rsrq, rssnr, 
           network_id_sim, test_type, icmp_ping_time, icmp_ping_packet_loss,
           icmp_ping_range, app_version_code))
testset.predict.rf.1$gsm.u <- predict(rf.gsm.u, testset.predict.rf.1)
summary(testset.predict.rf.1$gsm.u)

#
summary(testset.predict.rf.1)
testset.predict.rf.1$download_speed <- testset$download_speed
testset.predict.rf.1$upload_speed <- testset$upload_speed
summary(testset.predict.rf.1)
testset.backup <- testset.predict.rf.1

testset.predict.rf.1$download_speed <- as.character(levels(testset.predict.rf.1$download_speed))[testset.predict.rf.1$download_speed]
table(testset.predict.rf.1$download_speed)
testset.predict.rf.1$upload_speed <- as.character(levels(testset.predict.rf.1$upload_speed))[testset.predict.rf.1$upload_speed]
table(testset.predict.rf.1$upload_speed)

summary(testset$nw_type)
testset.predict.rf.1$nw_type <- testset$nw_type

#Replacing PREDICTs with speeds
testset.predict.rf.1[which(testset.predict.rf.1$download_speed == "PREDICT" & 
        testset.predict.rf.1$nw_type == "LTE"),]$download_speed <- 
        testset.predict.rf.1[which(testset.predict.rf.1$download_speed == "PREDICT" & 
        testset.predict.rf.1$nw_type == "LTE"),]$lte.d
head(testset.predict.rf.1$download_speed, 100)
testset.predict.rf.1[which(testset.predict.rf.1$upload_speed == "PREDICT" & 
                             testset.predict.rf.1$nw_type == "LTE"),]$upload_speed <- 
  testset.predict.rf.1[which(testset.predict.rf.1$upload_speed == "PREDICT" & 
                               testset.predict.rf.1$nw_type == "LTE"),]$lte.u
head(testset.predict.rf.1$upload_speed, 100)

testset.predict.rf.1[which(testset.predict.rf.1$download_speed == "PREDICT" & 
                             testset.predict.rf.1$nw_type == "UMTS"),]$download_speed <- 
  testset.predict.rf.1[which(testset.predict.rf.1$download_speed == "PREDICT" & 
                               testset.predict.rf.1$nw_type == "UMTS"),]$umts.d
head(testset.predict.rf.1$download_speed, 100)
testset.predict.rf.1[which(testset.predict.rf.1$upload_speed == "PREDICT" & 
                             testset.predict.rf.1$nw_type == "UMTS"),]$upload_speed <- 
  testset.predict.rf.1[which(testset.predict.rf.1$upload_speed == "PREDICT" & 
                               testset.predict.rf.1$nw_type == "UMTS"),]$umts.u
head(testset.predict.rf.1$upload_speed, 100)

testset.predict.rf.1[which(testset.predict.rf.1$download_speed == "PREDICT" & 
                             testset.predict.rf.1$nw_type == "CDMA"),]$download_speed <- 
  testset.predict.rf.1[which(testset.predict.rf.1$download_speed == "PREDICT" & 
                               testset.predict.rf.1$nw_type == "CDMA"),]$cdma.d
head(testset.predict.rf.1$download_speed, 100)
testset.predict.rf.1[which(testset.predict.rf.1$upload_speed == "PREDICT" & 
                             testset.predict.rf.1$nw_type == "CDMA"),]$upload_speed <- 
  testset.predict.rf.1[which(testset.predict.rf.1$upload_speed == "PREDICT" & 
                               testset.predict.rf.1$nw_type == "CDMA"),]$cdma.u
head(testset.predict.rf.1$upload_speed, 100)

testset.predict.rf.1[which(testset.predict.rf.1$download_speed == "PREDICT" & 
                             testset.predict.rf.1$nw_type == "GSM"),]$download_speed <- 
  testset.predict.rf.1[which(testset.predict.rf.1$download_speed == "PREDICT" & 
                               testset.predict.rf.1$nw_type == "GSM"),]$gsm.d
head(testset.predict.rf.1$download_speed, 100)
testset.predict.rf.1[which(testset.predict.rf.1$upload_speed == "PREDICT" & 
                             testset.predict.rf.1$nw_type == "GSM"),]$upload_speed <- 
  testset.predict.rf.1[which(testset.predict.rf.1$upload_speed == "PREDICT" & 
                               testset.predict.rf.1$nw_type == "GSM"),]$gsm.u
head(testset.predict.rf.1$upload_speed, 100)
 
#checking missing speeds
length(testset.predict.rf.1[which(testset.predict.rf.1$download_speed == "PREDICT"),]$download_speed)
length(testset.predict.rf.1[which(testset.predict.rf.1$download_speed == "SKIP"),]$download_speed)

#Filling NAs with mean values per technology
testset.predict.rf.1[which(testset.predict.rf.1$download_speed == "PREDICT" & is.na(testset.predict.rf.1$nw_type)),]$download_speed <- mean.na.d
testset.predict.rf.1[which(testset.predict.rf.1$upload_speed == "PREDICT" & is.na(testset.predict.rf.1$nw_type)),]$upload_speed <- mean.na.u

length(testset.predict.rf.1[which(testset.predict.rf.1$download_speed == "PREDICT"),]$download_speed)
length(testset.predict.rf.1[which(is.na(testset.predict.rf.1$download_speed)),]$download_speed)
length(testset.predict.rf.1[which(testset.predict.rf.1$upload_speed == "PREDICT"),]$upload_speed)
length(testset.predict.rf.1[which(is.na(testset.predict.rf.1$upload_speed)),]$upload_speed)
table(testset.predict.rf.1[which(is.na(testset.predict.rf.1$download_speed)),]$nw_type)
table(testset.predict.rf.1[which(is.na(testset.predict.rf.1$upload_speed)),]$nw_type)

testset.predict.rf.1[which(is.na(testset.predict.rf.1$download_speed) & 
                             testset.predict.rf.1$nw_type == "CDMA"),]$download_speed <- mean.cdma.d
testset.predict.rf.1[which(is.na(testset.predict.rf.1$upload_speed) & 
                             testset.predict.rf.1$nw_type == "CDMA"),]$upload_speed <- mean.cdma.u

testset.predict.rf.1[which(is.na(testset.predict.rf.1$download_speed) & 
                             testset.predict.rf.1$nw_type == "GSM"),]$download_speed <- mean.gsm.d
testset.predict.rf.1[which(is.na(testset.predict.rf.1$upload_speed) & 
                             testset.predict.rf.1$nw_type == "GSM"),]$upload_speed <- mean.gsm.u


#Saving outputs

write.table(select(testset.predict.rf.1, upload_speed, download_speed), file = "YetAnotherTeam_initial_test_2.csv", sep = ",", row.names = F)
